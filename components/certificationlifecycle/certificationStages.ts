import { Stage } from "@/app/lifecycle/page";
...
export const initialStages: Stage[] = [
  {
    ...
    documents: [
      {
        id: "doc-1",
        name: "Application form for Certification",
        uploaded: true,
      ...
      {
        id: "doc-5",
        name: "Document Review (Adequacy audit report)",
        uploaded: false,
      },
      {
        id: "doc-6",
        name: "Mail – date confirmation for Stage 1 audit",
        uploaded: false,
      },
    ],
  },
  {
    ...
    documents: [
      {
        id: "doc-7",
        name: "Stage 1 – Audit Plan and email communications",
        uploaded: false,
      },
      { id: "doc-8", name: "Stage 1 – Audit Report", uploaded: false },
      {
        id: "doc-9",
        name: "Stage 1 – Signed confidentiality forms",
        uploaded: false,
      },
      {
        id: "doc-10",
        name: "Stage 1 – Opening/Closing attendance sheets",
        uploaded: false,
      },
      {
        id: "doc-11",
        name: "Stage 1 – Corrective actions communications",
        uploaded: false,
      },
  ...
  },
  {
    ...
    documents: [
      {
        id: "doc-13",
        name: "Mail – date confirmation for Stage II audit",
        uploaded: false,
      },
    ],
  },
  {
    ...
    documents: [
      {
        id: "doc-14",
        name: "Stage II – Audit Plan and email communications",
        uploaded: false,
      },
      { id: "doc-15", name: "Stage II – Audit Report", uploaded: false },
      {
        id: "doc-16",
        name: "Stage II – Signed confidentiality forms",
        uploaded: false,
      },
      {
        id: "doc-17",
        name: "Stage II – Opening/Closing attendance sheets",
        uploaded: false,
      },
      { id: "doc-18", name: "Stage II – Audit log", uploaded: false },
      {
        id: "doc-19",
        name: "Stage II – Non-conformity Reports",
        uploaded: false,
      },
      {
        id: "doc-20",
        name: "Stage II – Closed NC reports + evidence",
        uploaded: false,
      },
    ],
  },
  {
    ...
    documents: [
      {
        id: "doc-21",
        name: "Certification Committee Meeting minutes",
        uploaded: false,
      },
      ...
      {
        id: "doc-26",
        name: "Terms & Conditions for Certification",
        uploaded: false,
      },
      {
        id: "doc-27",
        name: "Terms & Conditions for use of Certification Mark",
        uploaded: false,
      },
    ],
  },
  {
    ...
    documents: [
      {
        id: "doc-28",
        name: "Notification Letter – Surveillance I Audit",
        uploaded: false,
      },
    ],
  },
  {
    ...
    documents: [
      ...
      {
        id: "doc-31",
        name: "Surveillance I – Signed confidentiality forms",
        uploaded: false,
      },
      {
        id: "doc-32",
        name: "Surveillance I – Opening/Closing attendance sheets",
        uploaded: false,
      },
      {
        id: "doc-33",
        name: "Surveillance I – Non-conformity Report",
        uploaded: false,
      },
      {
        id: "doc-34",
        name: "Surveillance I – Closed NC Reports + evidence",
        uploaded: false,
      },
    ],
  },
  ...
  },
  {
    ...
    documents: [
      {
        id: "doc-36",
        name: "Notification Letter – Surveillance II Audit",
        uploaded: false,
      },
    ],
  },
  {
    ...
    documents: [
      ...
      {
        id: "doc-39",
        name: "Surveillance II – Signed confidentiality forms",
        uploaded: false,
      },
      {
        id: "doc-40",
        name: "Surveillance II – Opening/Closing attendance sheets",
        uploaded: false,
      },
      {
        id: "doc-41",
        name: "Surveillance II – Non-conformity Report",
        uploaded: false,
      },
      {
        id: "doc-42",
        name: "Surveillance II – Closed NC Reports + evidence",
        uploaded: false,
      },
    ],
  },
